...
export class CategoriesService {
  ...
  updateCategory(item:Categories): Observable<APIResponse<Categories>>{
    return this.http.put<APIResponse<Categories>>(`${this.API_URL}/update/${item._id}`, item).pipe(catchError(this._handleHttpErrors(new Categories())));
  }
