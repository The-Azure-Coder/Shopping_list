...
export class ShoppinglistService {
  ...
  updateItem(item:Items): Observable<APIResponse<Items>>{
    return this.http.put<APIResponse<Items>>(`${this.API_URL}/update/${item._id}`, item).pipe(catchError(this._handleHttpErrors(new Items())));
  }
